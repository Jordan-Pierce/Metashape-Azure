...
print(f"Setting AGISOFT_FLS environment variable to 10.71.68.13:5842")
os.environ["AGISOFT_FLS"] = "10.71.68.13:5842"  
...
class SfMWorkflow:
    def __init__(self,
        ...
        if self.output_name in output_dir or "output_data" in os.path.basename(output_dir).rstrip('/\\'):
