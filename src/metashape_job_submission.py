...
#takes in relavent information about the command and loads it into ML Studio Python SDK.
def submit_metashape_job(input_asset: str = None, 
                         input_version: str = None,
                         output_asset: str = None,
                         output_version: str = None,
                         metashape_license: str = None,
    ...
    #get the metashape license where it needs to be
    LICENSE = metashape_license
